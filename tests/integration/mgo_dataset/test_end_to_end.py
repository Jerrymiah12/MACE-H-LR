...
from workflows.mgo_dataset import convert, dfpt, export, locality, long_range, organize, reference, validate
from workflows.mgo_dataset import displacements as dp
from workflows.mgo_dataset.snapshot import SnapshotStore, load_reference
from maceh.data.structures import make_supercell
from tests.integration.mgo_dataset.test_convert import fabricate_dft
from tests.integration.mgo_dataset.test_dfpt_collect import PH_OUT
from tests.integration.mgo_dataset.test_lr_process import lr_cfg
...
def test_full_pipeline(tmp_path):
    ...
    assert long_range.lr_process_stage(cfg, ws, a) == 0
    ...
    # CLI smoke test
    r = subprocess.run([sys.executable, "-m", "workflows.mgo_dataset", "status",
