...
# See maceh/tests/test_scatter.py.
set -euo pipefail
...
import e3nn, pymatgen.core, h5py, torch_geometric
...
Next:
  ...
  $VENV/bin/python training/freeze_provenance.py --verify
  $VENV/bin/python training/check_split_wiring.py
  $VENV/bin/python training/smoke_onebatch.py
EOF
