...
Usage
-----
    python -m workflows.training.evaluate --sr-run DIR --full-run DIR --set test
    python -m workflows.training.evaluate --sr-run DIR --full-run DIR --set large
    python -m workflows.training.evaluate --sr-run DIR --set test        # one model only
"""
import argparse
import json
import os
